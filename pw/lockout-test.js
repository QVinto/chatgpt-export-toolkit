// lockout-test.js — JEDEN reálny fetch konverzácie, zistí či rate-limit lockout ustúpil.
'use strict';
const { chromium } = require('playwright');
const fs = require('fs'); const os = require('os'); const path = require('path');
// base-dir = nadradený priečinok tohto skriptu (pw/..) — prenositeľné pre akýkoľvek priečinok
...
(async()=>{
  ...
  console.log(ok ? 'VERDIKT: ✅ LOCKOUT USTÚPIL (200) — možno rozbehnúť' : 'VERDIKT: ⛔ stále '+ (r.status||r.error));
